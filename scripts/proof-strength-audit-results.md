...
```text
SUMMARY: 23 passed, 0 failed/timeout (0 timeout) out of 23
```
...
| `proof_v13_target_effective_lag_rejects_risk_increasing_trade_before_mutation` | 9s | PASS |
...
| `proof_v13_hlock_is_exactly_hmin_or_hmax` | 4s | PASS |
...
| File | Harnesses |
|---|---:|
| `tests/proofs_v13.rs` | 23 |

Strength indicators:

| Check | Result |
|---|---:|
| Harnesses over v13 production code | 23 |
...
The Rust suite currently covers 50 wide-math unit tests and 35 v13 spec tests.
...
blocking, resolved payout snapshot fairness, and permissionless account-local
